...
;Only 5 Server URLS will be enabled
ServerLaunchURL1:
  Run, %ServerURL1%
Return
...
; Gui, 2: Add, Text, x12 y30, Servers:
; Gui, 2: Add, Edit, x62 y27 w30, %NBR_SERVERS%
...
2GuiSubmit:
  ...
  ;Server 6
  IniWrite, %ServerName6%, DCLconfig.ini, Server 6, Name
  IniWrite, %ServerIP6%, DCLconfig.ini, Server 6, IPAddress
  IniWrite, %ServerPassword6%, DCLconfig.ini, Server 6, Password
  IniWrite, %ServerDMPassword6%, DCLconfig.ini, Server 6, DMPassword
  IniWrite, %ServerBanner6%, DCLconfig.ini, Server 6, Banner
  IniWrite, %ServerURL6%, DCLconfig.ini, Server 6, ServerURL
  ;Server 7
  IniWrite, %ServerName7%, DCLconfig.ini, Server 7, Name
  IniWrite, %ServerIP7%, DCLconfig.ini, Server 7, IPAddress
  IniWrite, %ServerPassword7%, DCLconfig.ini, Server 7, Password
  IniWrite, %ServerDMPassword7%, DCLconfig.ini, Server 7, DMPassword
  IniWrite, %ServerBanner7%, DCLconfig.ini, Server 7, Banner
  IniWrite, %ServerURL7%, DCLconfig.ini, Server 7, ServerURL
  ;Server 8
  IniWrite, %ServerName8%, DCLconfig.ini, Server 8, Name
  IniWrite, %ServerIP8%, DCLconfig.ini, Server 8, IPAddress
  IniWrite, %ServerPassword8%, DCLconfig.ini, Server 8, Password
  IniWrite, %ServerDMPassword8%, DCLconfig.ini, Server 8, DMPassword
  IniWrite, %ServerBanner8%, DCLconfig.ini, Server 8, Banner
  IniWrite, %ServerURL8%, DCLconfig.ini, Server 8, ServerURL
  ;Server 9
  IniWrite, %ServerName9%, DCLconfig.ini, Server 9, Name
  IniWrite, %ServerIP9%, DCLconfig.ini, Server 9, IPAddress
  IniWrite, %ServerPassword9%, DCLconfig.ini, Server 9, Password
  IniWrite, %ServerDMPassword9%, DCLconfig.ini, Server 9, DMPassword
  IniWrite, %ServerBanner9%, DCLconfig.ini, Server 9, Banner
  IniWrite, %ServerURL9%, DCLconfig.ini, Server 9, ServerURL
  ;Server 10
  IniWrite, %ServerName10%, DCLconfig.ini, Server 10, Name
  IniWrite, %ServerIP10%, DCLconfig.ini, Server 10, IPAddress
  IniWrite, %ServerPassword10%, DCLconfig.ini, Server 10, Password
  IniWrite, %ServerDMPassword10%, DCLconfig.ini, Server 10, DMPassword
  IniWrite, %ServerBanner10%, DCLconfig.ini, Server 10, Banner
  IniWrite, %ServerURL10%, DCLconfig.ini, Server 10, ServerURL
